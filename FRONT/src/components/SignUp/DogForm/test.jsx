      ...
      <div className="dog__form">
        <div className="dog__form__input-infos">
          <div className="dog__form__input-infos__first">
            {/* Race */}
            <select {...register('race', { required: 'Veuillez sélectionner la race' })} id="races-select" className="dog__commun">
              <option value="">Race</option>
              <option value="test1">test1</option>
              <option value="test2">test2</option>
            </select>
            {/* Age */}
            <input {...register('age', { required: 'Veuillez entrer l\'âge' })} type="number" placeholder="Age" className="dog__commun" />
            {/* Weight */}
            <input {...register('weight', { required: 'Veuillez entrer le poids' })} type="number" placeholder="Poids (kg)" className="dog__commun" />
          </div>
          <div className="dog__form__input-infos__others">
            ...
            <div className="dog__form__input-infos__others__sexe">
              ...
              {/* Female */}
              <input {...register('gender_id', { required: 'Veuillez sélectionner le genre' })} type="radio" id="femelle" name="femelle" value="1" checked />
              <label htmlFor="femelle" className="dog__commun">Femelle</label>
              {/* Male */}
              <input {...register('gender_id', { required: 'Veuillez sélectionner le genre' })} type="radio" id="male" value="2" />
            ...
            <div className="dog__form__input-infos__others__sterilized">
              ...
              <input {...register('sterilization')} type="radio" id="sterilized-yes" name="sterilization" />
              <label htmlFor="sterilized-yes" className="dog__commun">Oui</label>
              <input {...register('sterilization')} type="radio" id="sterilized-no" name="sterilization" checked />
          ...
          <div className="dog__form__input-infos__others__picture">
            <label htmlFor="photo_dog">Ajouter une photo de mon chien</label>
            <input
              {...register(('photo_dog'))}
              type="file"
              id="photo_dog"
